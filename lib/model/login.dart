...
Login loginUserFromJson(String str) => Login.fromJson(json.decode(str));

String loginUserToJson(Login data) => json.encode(data.toJson());
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        authToken: json["auth_token"] == null ? "-" : json["auth_token"].toString(),
        typeToken: json["type_token"] == null ? "-" : json["type_token"].toString(),
        user: json["user"] == null ? null : User.fromJson(json["user"]),
    );

    Map<String, dynamic> toJson() => {
        "auth_token": authToken == null ? "-" : authToken.toString(),
