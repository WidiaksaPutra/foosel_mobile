...
class CubitUpdateTransaksiLocal extends Cubit<DataStateUpdateTransaksiLocal> implements InterfacesUpdateTransaksiLocal{
  final InterfaceUpdateDataTransaksiLocal _dataUpdateTransaksiLocal = getItInstance<InterfaceUpdateDataTransaksiLocal>();
  ...
  updateDataTransaksiLocal({
    ...
    await _dataUpdateTransaksiLocal.updateDataTransaksiLocal(
      tokenId: tokenId, 
      jumlah: jumlah, 
